...
func Mark(m uint32) unixx.Uint32SockOpt {
	return unixx.NewUint32SockOpt(unix.SOL_SOCKET, unix.SO_MARK).Set(m)
}
...
func timestamping(flags int32) unixx.Int32SockOpt {
	return unixx.NewInt32SockOpt(unix.SOL_SOCKET, unix.SO_TIMESTAMPING).Set(flags)
}
